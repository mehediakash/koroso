...
const PageHeader = ({ title, description, breadcrumbs = [] }) => {
  return (
    <section className="relative py-16 lg:py-24 bg-primery from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 overflow-hidden">
      {/* Background Elements */}
    ...
    {index === breadcrumbs.length - 1 ? (
      ...
      <Link to={crumb.href} className="hover:text-primery transition-colors duration-200">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          {description && (
            <p className="text-lg lg:text-xl text-white dark:text-gray-300 leading-relaxed">
              {description}
            </p>
          )}
        </div>
